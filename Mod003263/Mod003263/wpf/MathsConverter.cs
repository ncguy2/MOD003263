/*
 * MathsConverter and accompanying samples are copyright (c) 2011 by Ivan Krivyakov
 * ivan [at] ikriv.com
...
namespace Mod003263.wpf
{
    ...
    /// </summary>
    /// <remarks>
    /// MathsConverter can act as a value converter, or as a multivalue converter (WPF only).
        ...
        IValueConverter
    {
        ...
        class Variable : IExpression
        {
            ...
            public decimal Eval(object[] args)
            {
                ...
                {
                    throw new ArgumentException(String.Format("MathsConverter: parameter index {0} is out of range. {1} parameter(s) supplied", _index, args.Length));
                }
        ...
        class Parser
        {
            ...
            public IExpression Parse(string text)
            {
                ...
                {
                    string msg =
                        String.Format("MathsConverter: error parsing expression '{0}'. {1} at position {2}", text, ex.Message, pos);
